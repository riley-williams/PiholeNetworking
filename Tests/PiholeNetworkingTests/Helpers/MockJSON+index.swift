...
extension MockJSON {
	...
	*  Please see LICENSE file for your rights under this license. -->
	...
	<link rel="stylesheet" href="style/vendor/SourceSansPro/SourceSansPro.css?v=1616984226">
	<link rel="stylesheet" href="style/vendor/bootstrap/css/bootstrap.min.css?v=1616984226">
	<link rel="stylesheet" href="style/vendor/datatables.min.css?v=1616984226">
	<link rel="stylesheet" href="style/vendor/daterangepicker.min.css?v=1616984226">
	<link rel="stylesheet" href="style/vendor/AdminLTE.min.css?v=1616984226">
	<link rel="stylesheet" href="style/vendor/select2.min.css?v=1616984226">
	
	<link rel="stylesheet" href="style/pi-hole.css?v=1616984226">
	<link rel="stylesheet" href="style/themes/default-dark.css?v=1616984226">
	<noscript>
	<link rel="stylesheet" href="style/vendor/js-warn.css?v=1616984226"></noscript>
	
	<script src="scripts/vendor/jquery.min.js?v=1616984226"></script>
	<script src="style/vendor/bootstrap/js/bootstrap.min.js?v=1616984226"></script>
	<script src="scripts/vendor/adminlte.min.js?v=1616984226"></script>
	<script src="scripts/vendor/bootstrap-notify.min.js?v=1616984226"></script>
	<script src="scripts/vendor/select2.min.js?v=1616984226"></script>
	<script src="scripts/vendor/datatables.min.js?v=1616984226"></script>
	<script src="scripts/vendor/moment.min.js?v=1616984226"></script>
	<script src="scripts/vendor/Chart.min.js?v=1616984226"></script>
	<script src="style/vendor/font-awesome/js/all.min.js?v=1616984226"></script>
	</head>
	...
	<p>To learn how to enable JavaScript click <a href="https://www.enable-javascript.com/" rel="noopener"
	target="_blank">here</a></p><label for="js-hide">Close</label>
	</div>
	</div>
	<!-- /JS Warning -->
	</noscript>
	...
	<a class="btn-link" href="https://github.com/pi-hole" rel="noopener"
	target="_blank">GitHub</a>
	</div>
	<div class="col-xs-4 text-center">
	<a class="btn-link" href="https://pi-hole.net/" rel="noopener"
	target="_blank">Website</a>
	</div>
	<div class="col-xs-4 text-center">
	<a class="btn-link" href="https://github.com/pi-hole/pi-hole/releases"
	rel="noopener" target="_blank">Updates</a>
	</div>
	...
	<p>Status</p>
	<span id="status"><i class="fa fa-circle text-green-light"></i> Active</span><span id="temperature"><i class="fa fa-fire text-vivid-blue"></i> Temp:&nbsp;<span id="rawtemp" hidden>39.166</span><span id="tempdisplay"></span></span>
	<br/>
	<span title="Detected 4 cores"><i class="fa fa-circle text-green-light"></i> Load:&nbsp;&nbsp;0.03&nbsp;&nbsp;0.07&nbsp;&nbsp;0.08</span>
	<br/>
	<span><i class="fa fa-circle text-green-light"></i> Memory usage:&nbsp;&nbsp;38.0&thinsp;%</span>
	</div>
	</div>
	...
	title="Blocking list updated one day, 21:41 (hh:mm) ago">
	<div class="inner">
	...
	<script src="scripts/pi-hole/js/utils.js?v=1616984226"></script>
	<script src="scripts/pi-hole/js/index.js?v=1616984226"></script>
	...
	<strong><a href="https://pi-hole.net/donate/" rel="noopener" target="_blank"><i class="fa fa-heart text-red"></i> Donate</a></strong>
	...
	<a href="https://github.com/pi-hole/pi-hole/releases/v5.2.4" rel="noopener"
	target="_blank">v5.2.4</a>
	</li>
	<li>
	<strong>Web Interface</strong>
	<a href="https://github.com/pi-hole/AdminLTE/releases/v5.4" rel="noopener"
	target="_blank">v5.4</a>
	</li>
	<li>
	<strong>FTL</strong>
	<a href="https://github.com/pi-hole/FTL/releases/v5.7" rel="noopener"
	target="_blank">v5.7</a>
	</li>
	</ul>
	</div>
	</div>
	...
	<!-- ./wrapper -->
	<script src="scripts/pi-hole/js/footer.js?v=1616984226"></script>
	</body>
