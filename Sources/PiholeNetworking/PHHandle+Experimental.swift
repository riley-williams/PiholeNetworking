...
extension PHHandle {
	...
	public func getRequestRatioTimeline(from: Date, until: Date, interval: TimeInterval) async throws -> PHRequestRatioTimeline {
	...
	public func getNetwork() async throws -> [PHNetworkClient] {
		guard let token = instance.apiKey,
